...
# NOTE (bounty kit adaptation): the source repo imports this from core's
# `vggt_slam.object_detector` (a different repo, CLIP+SAM3 model-backed).
# That's out of scope for this kit -- see agent_runtime/_interfaces.py for
# the stub (image_to_base64 / mask_overlay_to_base64 are real Pillow-backed
# reimplementations; segment_all / compute_3d_bbox raise NotImplementedError
# and must be faked via ObjectDetectorProtocol in tests).
from agent_runtime._interfaces import ObjectDetector
