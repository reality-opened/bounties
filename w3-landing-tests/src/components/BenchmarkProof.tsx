// KIT NOTE: original imports `next/link`. Rewired to a minimal local stub
// (test-stubs/next-link) so this kit doesn't need the `next` package —
// see test-stubs/next-link.tsx and the README.
import Link from "../../test-stubs/next-link";
